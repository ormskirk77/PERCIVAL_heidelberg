module cvxif_pau (clk,
 ...
 sky130_fd_sc_hd__dfxtp_2 _2357_ (.CLK(clk),
    ...
    .VPWR(VPWR),
    .Q(result_valid));
 sky130_fd_sc_hd__conb_1 _2358_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(issue_resp_register_read[0]));
 sky130_fd_sc_hd__conb_1 _2359_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(issue_resp_writeback));
 sky130_fd_sc_hd__conb_1 _2360_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(register_ready));
 sky130_fd_sc_hd__conb_1 _2361_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(result_data[16]));
 sky130_fd_sc_hd__conb_1 _2362_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(result_data[17]));
 sky130_fd_sc_hd__conb_1 _2363_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(result_data[18]));
 sky130_fd_sc_hd__conb_1 _2364_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(result_data[19]));
 sky130_fd_sc_hd__conb_1 _2365_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(result_data[20]));
 sky130_fd_sc_hd__conb_1 _2366_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(result_data[21]));
 sky130_fd_sc_hd__conb_1 _2367_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(result_data[22]));
 sky130_fd_sc_hd__conb_1 _2368_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(result_data[23]));
 sky130_fd_sc_hd__conb_1 _2369_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(result_data[24]));
 sky130_fd_sc_hd__conb_1 _2370_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(result_data[25]));
 sky130_fd_sc_hd__conb_1 _2371_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(result_data[26]));
 sky130_fd_sc_hd__conb_1 _2372_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(result_data[27]));
 sky130_fd_sc_hd__conb_1 _2373_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(result_data[28]));
 sky130_fd_sc_hd__conb_1 _2374_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(result_data[29]));
 sky130_fd_sc_hd__conb_1 _2375_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(result_data[30]));
 sky130_fd_sc_hd__conb_1 _2376_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(result_data[31]));
